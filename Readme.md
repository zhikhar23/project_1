...
5.decorators-для проверки выполняемости функции(вывод в log.txt если он передан) 
6.Добавлены модули для тестирования этих функций (использовались фикстуры и параметризации)
7.Добавлены функции для обработки файлов формата csv и xslx